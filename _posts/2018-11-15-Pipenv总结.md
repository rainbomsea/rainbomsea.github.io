...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20181114222348721.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM5MjY4MTkz,size_16,color_FFFFFF,t_70)

* 这样我们就需要把安装路径下的 bin(这里我的就是`/home/rainbomsea/.local`) 添加到 PATH 中.

* 打开`~/.bashrc`文件在最后一句加上 `export PATH=~/.local/bin:$PATH`
  
![在这里插入图片描述](https://img-blog.csdnimg.cn/20181114223224263.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20181115133201310.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM5MjY4MTkz,size_16,color_FFFFFF,t_70)
